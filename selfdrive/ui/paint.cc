...
static void ui_draw_vision_speed(UIState *s) {
  ...
  NVGcolor ForaBozo = COLOR_WHITE;
  ForaBozo = (*s->sm)["carState"].getCarState().getBrakeLightsDEPRECATED() ? nvgRGBA(255, 66, 66, 255) : ForaBozo;
  nvgTextAlign(s->vg, NVG_ALIGN_CENTER | NVG_ALIGN_BASELINE);
  ui_draw_text(s, s->fb_w/2, 210, speed_str.c_str(), 96 * 2.5, ForaBozo, "sans-bold");
